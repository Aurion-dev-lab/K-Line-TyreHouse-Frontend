...
/**
 * Client-side Tyre Export Payment DTO for sync operations.
 */
public class TyreExportPaymentDTO {
    ...
    public String getTyreExportId() { return tyreExportId; }
    public void setTyreExportId(String tyreExportId) { this.tyreExportId = tyreExportId; }
