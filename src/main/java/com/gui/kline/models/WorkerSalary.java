...
public class WorkerSalary {
    private final String name, role, avatarColor, status;
    private final int present, late, absent;
    private final double grossSalary, advances, creditBalance;

    public WorkerSalary(String name, String role, String avatarColor,
                        int present, int late, int absent,
                        double grossSalary, double advances, double creditBalance, String status) {
        this.name = name; this.role = role; this.avatarColor = avatarColor;
        this.present = present; this.late = late; this.absent = absent;
        this.grossSalary = grossSalary; this.advances = advances;
        this.creditBalance = creditBalance; this.status = status;
    }
